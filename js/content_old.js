...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updateState(state) {
    _browser().runtime.sendMessage({action: 'updateState', state: state});
  }

  // Update volume of tab
  function updateVolume(volume) {
    _browser().runtime.sendMessage({action: 'updateVolume', gain: volume});
  }
  ...
  _browser().runtime.onMessage.addListener(function(element) {
